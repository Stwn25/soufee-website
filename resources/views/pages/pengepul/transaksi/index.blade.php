                ...
                <tr class="py-4 border-b-2 border-[#d9d9d9]">
                    ...
                    <td class="flex justify-center py-4">
                        <div class="flex gap-2">
                            <a href="{{ route('terima-permintaan', $transaksi->id_transaksi) }}">
                                <p class="bg-[#ffb703] text-white py-2 px-3 rounded-md">Atur Jadwal</p>
                            </a>
                            {{-- <form action="" method="POST">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="bg-[#ff4b4b] text-white py-2 px-3 rounded-md">Tolak</button>
                            </form> --}}
                        </div>
                    </td>
                </tr>
