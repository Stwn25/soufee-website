            ...
            <div class="" id="data-profil">
                ...
                <form action="{{ route('update-profil-pengepul', Auth::user()->id_user) }}" method="POST" class="w-full flex flex-col" enctype="multipart/form-data">
                    ...
                    <div class="relative">
                        ...
                        <div id="bt-img" class="border-1 border-[#1C3F3A] bg-[#f9f7ed] grid grid-cols-[0.8fr_1fr] rounded-md px-2 cursor-pointer absolute bottom-0 right-[40%] gap-2 items-center">
